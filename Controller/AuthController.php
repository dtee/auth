...
class AuthController extends Controller
{
    ...
    public function registerAction()
    {
        ...
        $form = $formFactory->createBuilder('form', $userAuth)
            ->add('email', 'text')
        ...
        else
        {
            ...
            $content = $this->renderView('OdlAuthBundle:Auth:create.html.twig', $params);
        }
    ...
    public function fbAuth()
    {
        ...
        $currentToken = $this->get('security.context')
            ->getToken();
        $user = null;
        if ($currentToken)
        {
    ...
    public function loginAction()
    {
        ...
        else
        {
            ...
            $content = $this->renderView('OdlAuthBundle:Auth:login.html.twig', $params);
        }
        $response->setContent($content);
    ...
    {
        $providerKey = $this->container->getParameter('fos_user.firewall_name');
        $token = new UsernamePasswordToken($user->getEmail(), $user->getPlainPassword(), $providerKey, $user->getRoles());
